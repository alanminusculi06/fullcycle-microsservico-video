...
trait TestSaves
{
    ...
    protected function assertStore($sendData, array $testDatabase, array $testJsonData = null): TestResponse
    {
    ...
    protected function assertUpdate($sendData, array $testDatabase, array $testJsonData = null): TestResponse
    {
